...
namespace SlimConcurrentCollections
{
    ...
    public class ConcurrentList<T> : IList<T>, ICollection<T>, IReadOnlyList<T>, IReadOnlyCollection<T>, IEnumerable<T>, IEnumerable, IDisposable
    {
        ...
        /// The number of elements in the source <see cref="ConcurrentList{T}"/>
